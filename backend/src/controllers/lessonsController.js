...
const getLessons = async (req, res) => {
  try {
    ...
    // Add status filter if provided (completed, new, in_progress)
    if (status) {
      paramCount++;
      const statusCondition = `status = $${paramCount}`;
    ...
    // Format lessons with user progress
...
// @desc    Get specific lesson with details
...
// @desc    Complete a lesson session
